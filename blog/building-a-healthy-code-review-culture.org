...
#+HUGO_BUNDLE: building-a-healthy-code-review-culture
#+HUGO_SLUG: building-a-healthy-code-review-culture
#+HUGO_TAGS: software "team building"
#+HUGO_ALIASES: /blog/2015/05/14/building-a-healthy-code-review-culture/ /blog/2016/07/26/building-a-healthy-code-review-culture/
...
#+begin_plainsummary
In short: I share how I think teams should run code review -- not mainly to hunt for bugs, but to share knowledge and become better, more engaged teammates. I offer practical advice for giving and receiving feedback kindly, and for writing clear commit messages and change descriptions that explain why a change was made.
#+end_plainsummary
...
- Don't use sarcasm.
- Keep it real. If emoji, animated {{{abbr(GIFs,Graphics Interchange Format images)}}}, or humor aren't you, don't force them. If they are, deploy them with aplomb.
...
- Steel Man (or Steel Person) :: restating someone's argument in its strongest possible form before responding to it.
- selective ownership :: treating pieces of code as personally owned ("mine" versus "yours") rather than shared by the team.
- Continuous Integration :: a system that automatically builds and tests the code on every change.
- green :: shorthand for a test suite in which every automated test is passing.
- out-of-band :: handled outside the normal channel -- here, in a separate conversation rather than in the review.
- pull request :: a request to review a set of proposed changes and merge them into the main code.
- diff :: the line-by-line difference showing exactly what a change added, removed, or altered.
