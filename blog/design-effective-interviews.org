...
#+HUGO_BUNDLE: design-effective-interviews
#+HUGO_SLUG: design-effective-interviews
#+HUGO_TAGS: hiring "team building"
#+HUGO_ALIASES: /blog/2019/05/09/design-effective-interviews/
...
#+begin_plainsummary
In short: I interview candidates by weighing both their technical skills and their people skills. Instead of directly asking the three things I most want to know -- can they do the job, will they improve the team, and will they be happy here -- I ask for concrete examples from their past and look for patterns. I try to keep candidates comfortable, stay honest about my organization's strengths and weaknesses, and treat each interview as practice to get better.
#+end_plainsummary
...
- TL;DR :: short for "too long; didn't read" -- a brief summary for readers who want the gist without the full article.
- Gateway Pattern :: a software design that hides access to an external system behind a single, simple interface.
- interview smell :: a warning sign that something about an interview's approach is likely to distort its outcome.
- Distributed Systems :: software that runs across many networked computers that work together as one.
- zeitgeist :: the shared mood, values, and culture of a group or organization at a given time.
